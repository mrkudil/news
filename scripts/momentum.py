...
# momentum.py now publishes live price_current/_price_current for live-only
# pivot.py and writes matching rates.json for dashboard NOW price alignment.
# -----------------------------------------------------------------------------
"""
momentum.py
...
_RATES_FILE_ENV = os.environ.get("RATES_FILE") or os.environ.get("MOMENTUM_RATES_FILE")
...
RATES_FILE = Path(_RATES_FILE_ENV) if _RATES_FILE_ENV else (BASE_DIR / "rates.json")
